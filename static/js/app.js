...
.config (function ($routeProvider){
	$routeProvider
        	.when('/', {controller:'allProducts', templateUrl: 'app/view/allproducts.html'})
        	.when('/reception', {controller:'reception', templateUrl: 'app/view/reception.html'})
        	.when('/kitchen', {controller:'kitchen', templateUrl: 'app/view/kitchen.html'})
        	.when('/arch', {controller:'arch', templateUrl: 'app/view/arch.html'})
        	.when('/special', {controller:'special', templateUrl: 'app/view/special.html'})
        	.when('/tables', {controller:'tables', templateUrl: 'app/view/tables.html'})
        	.when('/decor', {controller:'decor', templateUrl: 'app/view/decor.html'})
        	.when('/living', {controller:'living', templateUrl: 'app/view/living.html'})
